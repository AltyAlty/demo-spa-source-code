...
import {AppStateType, InferActionsTypes, BaseThunkType} from './redux-store'; /*Импортируем типы.*/
...
Здесь указан старый тип типизирования без использования "BaseThunkType", так как выдает ошибку, в дальнейшем будет
исправлено.
*/
