...
"ActionsType", созданный нами ниже.*/
    switch (action.type) {
        case 'demo-spa/users-reducer/FOLLOW': /*Меняем флаг у пользователя, что мы его теперь фоллловим.*/
            return {
        ...
        case 'demo-spa/users-reducer/UNFOLLOW': /*Меняем флаг у пользователя, что мы больше его не фоллловим.*/
            return {
                ...state, /*Делаем поверхностную копию "state".*/
                users: updateObjectInArray<UserType, keyof UserType, Partial<UserType>>
        ...
        case 'demo-spa/users-reducer/SET-USERS': /*Добавляем данные о пользователях "users" в "state", полученные с
        сервера.*/
            return {
                ...state, /*Делаем поверхностную копию "state".*/
        ...
        case 'demo-spa/users-reducer/SET-CURRENT-PAGE': /*Устанавливаем значение текущей выбранной страницы в
        ...
        case 'demo-spa/users-reducer/SET-TOTAL-USERS-COUNT': /*Устанавливаем общее количество пользователей в"state".*/
            return {
                ...state, /*Делаем поверхностную копию "state".*/
        ...
        case 'demo-spa/users-reducer/TOGGLE-IS-FETCHING': /*Указываем находится ли в процессе запрос на сервер на
        ...
        case 'demo-spa/users-reducer/TOGGLE-IS-FOLLOWING-IN-PROGRESS': /*Оперируем массивом "WhoIsInFollowingProgress"
        для указания находятся ли или нет какие-либо пользователи в процессе анфолловинга/фолловинга.*/
            return {
                ...state, /*Делаем поверхностную копию "state".*/
        ...
        постраничном выводе пользователей в "state". Здесь благодаря деструктуризации мы сможем передать нужные значения
