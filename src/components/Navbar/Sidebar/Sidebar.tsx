...
*/
const SideBar: React.FC<PropsType> = ({id, name, avatar}) => { /*Указываем какие именно "props" мы
...
export default SideBar; /*Экспортируем компонент "Sidebar" по default и будем его использовать в нашем проекте под
именем "SideBar", экспорт необходим для импорта.*/