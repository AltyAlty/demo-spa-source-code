...
*/
const Music: React.FC<PropsType> = (props) => { /*Указали при помощи "React.FC<>", что "props" в
этом функциональном компоненте имеют тип "PropsType".*/
...
export default Music; /*Экспортируем компонент "Music" по default и будем его использовать в нашем проекте под
именем "Music", экспорт необходим для импорта.*/