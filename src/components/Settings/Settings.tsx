...
*/
const Settings: React.FC<PropsType> = (props) => { /*Указали при помощи "React.FC<>", что
...
export default Settings; /*Экспортируем компонент "Settings" по default и будем его использовать в нашем проекте под
именем "Settings", экспорт необходим для импорта.*/