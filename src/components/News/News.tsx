...
*/
const News: React.FC<PropsType> = (props) => { /*Указали при помощи "React.FC<>", что "props" в
...
export default News; /*Экспортируем компонент "News" по default и будем его использовать в нашем проекте под
именем "News", экспорт необходим для импорта.*/