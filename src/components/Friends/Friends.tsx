...
*/
const Friends: React.FC<PropsType> = (props) => { /*Указали при помощи "React.FC<>", что "props"
в этом функциональном компоненте имеют тип "PropsType".*/
...
export default Friends; /*Экспортируем компонент "Friends" по default и будем его использовать в нашем проекте под
именем "Friends", экспорт необходим для импорта.*/